...
const skills = [
  {
    ...
    desc: "Основы инвестиций, личный бюджет и фундаментальный анализ рынка.",
  },
  {
    icon: BarChart3,
    name: "Data Analytics",
    desc: "Excel и Google Sheets, сбор данных, визуализация и базовая работа с SQL.",
  },
  {
    icon: Brain,
    name: "Soft Skills",
    desc: "Критическое мышление, тайм-менеджмент, нетворкинг и публичные выступления.",
  },
];
...
const mosaic = [
  { src: travel, span: "col-span-2 row-span-2 aspect-[3/4]", style: { objectPosition: "50% 40%" }, label: "Горы Алматы" },
  { src: istanbul, span: "aspect-square", style: { objectPosition: "50% 35%" }, label: "Лондон · Сити" },
  { src: sport, span: "aspect-square", style: { objectPosition: "50% 30%", filter: "grayscale(0.4) sepia(0.15)" }, label: "Утро" },
  { src: architecture, span: "aspect-square", style: { objectPosition: "50% 40%" }, label: "Архитектура" },
  { src: tech, span: "aspect-square", style: { objectPosition: "50% 50%" }, label: "Детали" },
];
    ...
    <Layout>
      ...
      <section className="container pt-12 md:pt-20 pb-16">
        <div className="flex items-center gap-4 mb-8">
          ...
          <span className="text-[10px] uppercase tracking-[0.25em] text-muted-foreground">Энергия и фокус</span>
        </div>

        <h1 className="font-serif text-6xl md:text-8xl font-light leading-[0.95] text-balance max-w-5xl animate-slide-up">
          Что <em className="text-terracotta">держит меня</em> в фокусе.
        </h1>
        <Reveal delay={1}>
          <p className="mt-8 max-w-2xl font-serif text-xl text-ink/85 italic leading-relaxed">
            Спорт, путешествия и навыки, которые я качаю каждый день — три источника моей энергии.
          </p>
        </Reveal>
      </section>
        ...
        <article className="grid md:grid-cols-12 gap-10 items-center">
          ...
          <Reveal className="md:col-span-5 md:pl-4" delay={1}>
            <div className="flex items-center gap-3 mb-6 text-terracotta">
              <Dumbbell size={20} />
              <span className="text-[10px] uppercase tracking-[0.3em]">Глава 01 · Спорт</span>
            </div>
            <h2 className="font-serif text-5xl md:text-6xl font-light leading-[1] mb-3">
              Дисциплина<span className="text-terracotta">.</span>
            </h2>
            <p className="font-serif italic text-xl text-muted-foreground mb-6">
              Выносливость и фокус — основа любой сложной задачи.
            </p>
            <p className="text-base leading-relaxed text-ink/90 mb-8 text-pretty">
              Спорт помогает сохранять фокус, когда нужно разобраться в сложных моделях, длинных таблицах и долгих лекциях. Ежедневная тренировка тренирует не только тело — она учит доводить до конца всё остальное: проекты, дедлайны, цели.
            </p>
            <ul className="space-y-2 border-t border-ink/15 pt-6">
              {["Пилатес и силовые 4 раза в неделю", "Утренние пробежки", "Йога по воскресеньям", "Сон 8 часов как KPI"].map((item, i) => (
                <li
                  key={item}
        ...
        <div className="container py-24 md:py-32">
          <div className="mb-14 grid md:grid-cols-12 gap-10 items-end">
            <Reveal className="md:col-span-7">
              <div className="flex items-center gap-3 mb-6 text-terracotta">
                <Plane size={20} />
                <span className="text-[10px] uppercase tracking-[0.3em]">Глава 02 · Путешествия</span>
              </div>
              <h2 className="font-serif text-5xl md:text-7xl font-light leading-[0.95] mb-4">
                Расширяю <em className="text-terracotta">кругозор</em>,<br/>чтобы понимать рынки.
              </h2>
            </Reveal>
            <Reveal className="md:col-span-4 md:col-start-9" delay={1}>
              <p className="font-serif italic text-lg text-muted-foreground">
                Новые страны — это новый опыт и расширение кругозора, что важно для глобального понимания экономики и рынков.
              </p>
            </Reveal>
          </div>
      ...
      <section className="container py-24 md:py-32">
        <div className="grid md:grid-cols-12 gap-10 items-end mb-14">
          <Reveal className="md:col-span-7">
            <div className="flex items-center gap-3 mb-6 text-terracotta">
              <BarChart3 size={20} />
              <span className="text-[10px] uppercase tracking-[0.3em]">Глава 03 · Скиллы</span>
            </div>
            <h2 className="font-serif text-5xl md:text-7xl font-light leading-[0.95] text-balance">
              Скиллы, которые я <em className="text-terracotta">качаю</em>.
            </h2>
          </Reveal>
          <Reveal className="md:col-span-4 md:col-start-9" delay={1}>
            <p className="font-serif italic text-muted-foreground">
              Три направления, в которые инвестирую время на 1 курсе. Растут каждый месяц.
            </p>
          </Reveal>
        </div>
        ...
        <Reveal>
          <div className="mt-12 p-8 md:p-10 border border-ink/15 bg-paper-warm flex flex-col md:flex-row items-start md:items-center gap-6 justify-between">
            <p className="font-serif italic text-xl md:text-2xl text-ink leading-snug max-w-2xl">
              «Хочу, чтобы за год эти три скилла переросли в реальные проекты — отчёты, дашборды, инвестиционные кейсы».
            </p>
            <span className="text-xs uppercase tracking-[0.3em] text-terracotta whitespace-nowrap">— Мой план</span>
          </div>
        </Reveal>
      </section>
    </Layout>
